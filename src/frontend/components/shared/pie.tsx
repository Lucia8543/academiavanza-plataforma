  ...
  return (
    <footer className="mt-20 border-t border-gris-borde bg-gris-claro">
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        <p className="max-w-2xl text-sm leading-relaxed text-gris-medio">
          <span className="font-semibold text-carbon">AcademiAvanza</span> pone
          en contacto a familias y profesores particulares en Madrid. No damos
          clases, no empleamos a los profesores y no intervenimos en el precio ni
          en los horarios. El colegio y los estudios que aparecen en cada ficha
          los declara el propio profesor.
        </p>
